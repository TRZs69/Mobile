...
class LevelyQuizBank {
  ...
  static List<QuizQuestion> allQuestions() => [
        ..._easy(),
        ..._medium(),
        ..._hard(),
      ];

  static List<QuizQuestion> by(String topic, QuizDifficulty difficulty) {
    return allQuestions().where((q) => q.topic == topic && q.difficulty == difficulty).toList();
  }

  static List<QuizQuestion> _easy() => const [
        QuizQuestion(
          id: 'u-e-1',
          topic: 'Usability',
  ...
  static List<QuizQuestion> _medium() => const [
        QuizQuestion(
          id: 'u-m-1',
          topic: 'Usability',
  ...
  static List<QuizQuestion> _hard() => const [
        QuizQuestion(
          id: 'u-h-1',
          topic: 'Usability',
