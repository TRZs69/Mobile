    ...
    Widget bubbleContent = Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (showIndicator) const Padding(padding: EdgeInsets.only(top: 6), child: TypingIndicator()),
        ],
      ),
    );

    // Only enable SelectionArea for Assistant messages to prevent gesture conflicts with User message editing
    if (!isUser) {
          ...
          SelectionArea(
            contextMenuBuilder: (context, selectableRegionState) {
              ...
              for (final type in types) {
                final index = buttonItems.indexWhere((item) => item.type == type);
                if (index != -1) {
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: const [
                          Icon(Icons.copy_rounded, size: 14, color: Colors.black45),
                          SizedBox(width: 4),
                          Text(
                            'Salin',
                            style: TextStyle(
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: const [
                            Icon(Icons.refresh_rounded, size: 14, color: Colors.black45),
                            SizedBox(width: 4),
                            Text(
                              'Retry',
                              style: TextStyle(
