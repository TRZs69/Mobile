...
class _TradeDetailScreenState extends State<TradeDetailScreen> {
  ...
  void showCompletionDialog(
      BuildContext context, String message, bool isAssignment) {
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: _isPurchaseValid(reqPoint)
                              ? () => _purchase(reqPoint)
                              : null,
